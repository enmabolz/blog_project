...
from .views import PostList, PostDetails, PostCreation, PostDelete, PostUpdate, CommentCreation
...
urlpatterns = [
    ...
    path('<int:pk>/comment/create', CommentCreation.as_view(), name='comment-create'),
] 
